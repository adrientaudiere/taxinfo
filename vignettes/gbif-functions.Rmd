...
```{r echo=FALSE, fig.cap="GBIF occurrence counts by taxon", fig.alt="Horizontal bar chart showing GBIF occurrence counts for different taxa on a log scale. Bars are colored by taxonomic Order and arranged by occurrence count from lowest to highest. Taxon names are displayed on the y-axis.", out.width="100%"}
