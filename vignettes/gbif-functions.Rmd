...
Here's an example of what GBIF occurrence data visualization looks like:

```{r echo=FALSE, fig.cap="Example GBIF occurrence counts by taxon", out.width="100%"}
# Create example data for demonstration
set.seed(123)
example_gbif <- data.frame(
  taxon = paste("Species", LETTERS[1:8]),
  occurrences = c(1250, 850, 2340, 450, 3200, 150, 890, 1680)
) |>
  mutate(taxon = reorder(taxon, occurrences))

gbif_plot <- ggplot(example_gbif, aes(x = taxon, y = occurrences)) +
