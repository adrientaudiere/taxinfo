...
```{r, fig.alt="Scatter plot showing molecular abundance (log10 scale) on the x-axis and taxa names on the y-axis. Points are colored by ecological guild, sized by number of publications, and shaped to indicate Quercus interaction. Wikipedia page view counts are displayed as text labels next to each point."}
