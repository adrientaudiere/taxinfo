...
```{r echo=FALSE, fig.cap="Basic taxinfo workflow for enriching phyloseq objects", out.width="100%"}
# This would display a workflow diagram if the figures were created
