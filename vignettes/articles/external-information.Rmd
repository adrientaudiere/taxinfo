...
<div id='msg-popup-unnamed-chunk-2' class='popup' role='dialog' aria-hidden='true' onclick='event.stopPropagation();'><button class='popup-close' aria-label='Close'>&times;</button><div class='popup-header'><strong>Messages</strong></div><pre class='popup-pre'>#&gt; ℹ Some GNA `data_sources` are older than 365 days; name resolution may miss
#&gt;   recent taxa:
...
<div id='msg-popup-unnamed-chunk-12' class='popup' role='dialog' aria-hidden='true' onclick='event.stopPropagation();'><button class='popup-close' aria-label='Close'>&times;</button><div class='popup-header'><strong>Messages</strong></div><pre class='popup-pre'>#&gt; ℹ Some GNA `data_sources` are older than 365 days; name resolution may miss
#&gt;   recent taxa:
#&gt;   TAXREF (id 210): last updated 2025-04-02
#&gt; ℹ Compare update dates at &lt;https://verifier.globalnames.org/data_sources&gt;.
#&gt; ✔ GNA verification summary:
...
<div id='msg-popup-unnamed-chunk-14' class='popup' role='dialog' aria-hidden='true' onclick='event.stopPropagation();'><button class='popup-close' aria-label='Close'>&times;</button><div class='popup-header'><strong>Messages</strong></div><pre class='popup-pre'>#&gt; ✔ Added 43 columns from '/home/adrien/R/x86_64-pc-linux-gnu-library/4.6/taxinfo/extdata/TAXREFv18_fungi.csv' with information for 13 taxa in the tax_table slot of the phyloseq object
</pre></div>
...
<div id='msg-popup-unnamed-chunk-16' class='popup' role='dialog' aria-hidden='true' onclick='event.stopPropagation();'><button class='popup-close' aria-label='Close'>&times;</button><div class='popup-header'><strong>Messages</strong></div><pre class='popup-pre'>#&gt; ℹ Some GNA `data_sources` are older than 365 days; name resolution may miss
#&gt;   recent taxa:
#&gt;   TAXREF (id 210): last updated 2025-04-02
#&gt; ℹ Compare update dates at &lt;https://verifier.globalnames.org/data_sources&gt;.
#&gt; ✔ GNA verification summary:
