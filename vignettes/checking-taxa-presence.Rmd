...
```{r, fig.alt="Interactive leaflet map centered on Paris showing GBIF occurrence points for Fagus sylvatica. Blue circles represent occurrence locations within a 50km radius, and an orange marker shows the center point at Paris coordinates (2.3522E, 48.8566N)."}
