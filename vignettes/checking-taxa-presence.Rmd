...
example_data <- data.frame(
  taxa_name = c("Fusarium oxysporum", "Trichoderma harzianum", "Penicillium chrysogenum",
                "Aspergillus niger", "Candida albicans"),
  count_in_radius = c(45, 23, 67, 12, 8),
  total_count_in_world = c(15420, 8930, 23450, 5670, 2340)
)
...
example_plot <- example_data %>%
  ...
  geom_col(aes(fill = log10(total_count_in_world)), alpha = 0.7) +
  scale_fill_viridis_c(name = "Global\nOccurrences\n(log10)") +
  labs(title = "Taxa Occurrence Check Results",
       subtitle = "Within 100 km radius of sampling location",
