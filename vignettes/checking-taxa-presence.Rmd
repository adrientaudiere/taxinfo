...
knitr::opts_chunk$set(eval = has_cc)
```
...
```{r, eval=requireNamespace("leaflet", quietly=TRUE) && requireNamespace("leafpop", quietly=TRUE), fig.alt="Interactive leaflet map centered on Paris showing GBIF occurrence points for Fagus sylvatica. Blue circles represent occurrence locations within a 50km radius, and an orange marker shows the center point at Paris coordinates (2.3522E, 48.8566N)."}
...
```{r, fig.alt="Summary of a phyloseq object"}
# Load example data
