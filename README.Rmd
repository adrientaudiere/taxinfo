...
- **genus**: Just the genus part (e.g., "Stereum")
- **specificEpithet**: Just the species epithet part (e.g., "ostrea")
- **namePublishedInYear**: The year the name was published (e.g., "1838")

Other terms come from [verifier globalnames](https://verifier.globalnames.org/) (camel case naming convention):
- **currentCanonicalSimple**: The simplified scientific name without authorship (e.g., "Stereum ostrea"). It correspond to concatenation of the `genus` and `specificEpithet` fields.
